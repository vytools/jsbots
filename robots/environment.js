export function environment(XTHREE, CONFIG, ground_geometry) {
  ...
  const baseColor = textureLoader.load('../vybot/textures/metalTile/basecolor.jpg');
  const normalMap = textureLoader.load('../vybot/textures/metalTile/normal.jpg');
  const heightMap = textureLoader.load('../vybot/textures/metalTile/height.png');
  const roughness = textureLoader.load('../vybot/textures/metalTile/roughness.jpg');
  const metallic = textureLoader.load('../vybot/textures/metalTile/metallic.jpg');
  const ambOcc = textureLoader.load('../vybot/textures/metalTile/ambientOcclusion.jpg');
  ...
  const starImage = textureLoader.load('../vybot/textures/galaxy1.png');
